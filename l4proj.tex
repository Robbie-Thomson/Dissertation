...
% EF: I'd be tempted to split this in half and combine it with the Implementation section. Across these sections, you go: "tried ambient light, didn't work so used proximity, <this> is why ambient light didn't work, so used proximity instead. Much easier to read if you restructure it, so that you're talking about the issues in line with the implementation approach.
...
% EF: I don't understand the "provide an example" part - provide an example of what? This seems unrelated to the quantitative analysis of scale ratings, so keep it separate and put it into a later section.
...
% EF: As mentioned previously, move the above paragraphs into the new results structure.
...
% EF: This is as far as I've read so far.
